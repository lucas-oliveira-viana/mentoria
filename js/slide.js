$(document).ready(() => {
    ...
    const tatsumaki = {
        ...
        heroBackground: `linear-gradient(to right, rgba(0, 0, 0, 0.7) 30%, rgba(0, 0, 0, 0.7) 100%), url(./img/tatsumaki.jpg)`
    }
    ...
    const bang = {
        ...
        heroBackground: `linear-gradient(to right, rgba(0, 0, 0, 0.7) 30%, rgba(0, 0, 0, 0.7) 100%), url(./img/bang.png)`
    }
    ...
    const atomicSamurai = {
        ...
        heroBackground: `linear-gradient(to right, rgba(0, 0, 0, 0.7) 30%, rgba(0, 0, 0, 0.7) 100%), url(./img/atomic-samurai.jpg)`
    }
    ...
    const makeRanking = (heroInformations) => {
        ...
        $("#ranking").css("border-top", `15px solid ${heroInformations.rgb})`)
